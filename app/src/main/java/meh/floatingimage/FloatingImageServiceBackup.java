...
public class FloatingImageServiceBackup extends Service {
    private WindowManager mWindowManager;
    private View mFloatingView;

    public FloatingImageServiceBackup() {
    }
    ...
    public void onCreate() {
        ...
        */
        ...
        //Set the shrink button
        ImageView closeButton = mFloatingView.findViewById(R.id.image_small);
